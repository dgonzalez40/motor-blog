...
<body data-page="about">
      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
          <div class="glass-card p-4 p-md-5">
            ...
            <h3 class="fw-bold">What you’ll find here</h3>
            <ul class="custom-list">
              <li>Motorcycle trip write-ups with routes, gear notes, and lessons learned</li>
              <li>Home lab and tech projects with architecture, tools, and troubleshooting notes</li>
              <li>Consistent post layouts with images and optional video</li>
              <li>A growing archive of practical experiments and personal builds</li>
            </ul>

            <hr class="my-4" />

            <h3 class="fw-bold">Areas of interest</h3>
            <div class="d-flex flex-wrap gap-2">
              <span class="tag-chip">Motorcycles</span>
              <span class="tag-chip">Home Lab</span>
              <span class="tag-chip">Automation</span>
              <span class="tag-chip">Networking</span>
              <span class="tag-chip">DIY Builds</span>
              <span class="tag-chip">Documentation</span>
              <span class="tag-chip">Troubleshooting</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="site-footer py-4">
    <div class="container">
      <p class="mb-0">© 2026 Daniel Gonzalez — About</p>
    </div>
  </footer>
